...
const PlaybackControls = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-[#0f172a] via-[#1e1b4b] to-[#0f172a] border-b border-white/10 backdrop:blur-md rounded-md h-20 sm:h-24 border-t  px-4">
        ...
        <div className="hidden sm:flex items-center gap-4 min-w-[180px] w-[30%] justify-end">
          <div className="flex items-center gap-2">
            <Button
              ...
              transition-colors"
            >
              {!muted ? <Volume1 className="h-4 w-4" /> : <VolumeX className="h-4 w-4" />}
            </Button>
